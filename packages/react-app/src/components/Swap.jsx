...
function Swap({ selectedProvider, tokenListURI }) {
  ...
  const [slippageTolerance, setSlippageTolerance] = useState(
    new Percent(Math.square(defaultSlippage * 100).toString(), "10000"),
  );
    ...
    >
      <Space direction="vertical">
        ...
        <Row justify="center" align="middle">
          <Space>
            {inputIsToken ? (
              <Button size="small" loading={approving} disabled={!insufficientAllowance} onClick={approveRouter}>
          ...
          <Descriptions.Item label="slippageTolerance">
            <InputNumber
              ...
              onChange={value => {
                ...
                const slippagePercent = new Percent(Math.square(value * 100).toString(), "10000");
