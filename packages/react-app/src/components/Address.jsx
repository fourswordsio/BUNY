...
/** 
  ...
  - Provide blockExplorer={blockExplorer}, click on address and get the link
              (ex. by default "https://testnet.snowtrace.io/" or for xdai "https://blockscout.com/poa/xdai/")
  ...
  if (props.minimized) {
    return (
      <span style={{ verticalAlign: "middle" }}>
        <a
          style={{ color: currentTheme === "light" ? "#fff" : "#ddd" }}
          target="_blank"
          href={etherscanLink}
      ...
      <span style={{ verticalAlign: "middle", paddingLeft: 5, fontSize: props.fontSize ? props.fontSize : 14 }}>
        {props.onChange ? (
          <Text editable={{ onChange: props.onChange }} copyable={{ text: address }}>
            <a
              style={{ color: currentTheme === "light" ? "white" : "#ddd" }}
              target="_blank"
              href={etherscanLink}
              rel="noopener noreferrer"
            >
          ...
          <Text copyable={{ text: address }}>
            <a
              style={{ color: currentTheme === "light" ? "orange" : "#ddd" }}
              target="_blank"
              href={etherscanLink}
              rel="noopener noreferrer"
            >
